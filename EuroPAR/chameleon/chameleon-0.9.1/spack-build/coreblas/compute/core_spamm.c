...
static inline int CORE_spamm_a2(MORSE_enum side, MORSE_enum trans, MORSE_enum uplo,
                                int M, int N, int K, int L,
                                int vi2, int vi3,
                                float *A2, int LDA2,
                                const float *V, int LDV,
                                float *W, int LDW);
static inline int CORE_spamm_w(MORSE_enum side, MORSE_enum trans, MORSE_enum uplo,
                               int M, int N, int K, int L,
                               int vi2, int vi3,
 ...
 ******************************************************************************/
int
CORE_spamm(int op, MORSE_enum side, MORSE_enum storev,
           int M, int N, int K, int L,
           const float *A1, int LDA1,
                 float *A2, int LDA2,
           const float *V, int LDV,
                 float *W, int LDW)
{
    ...
    if (storev == MorseColumnwise) {
        uplo = CblasUpper;
        if (side == MorseLeft) {
            trans = op == MorseA2 ? MorseNoTrans : MorseTrans;
            vi2 = trans == MorseNoTrans ? M - L : K - L;
        }
        else {
            trans = op == MorseW ? MorseNoTrans : MorseTrans;
...
/***************************************************************************/
static inline int
CORE_spamm_w(MORSE_enum side, MORSE_enum trans, MORSE_enum uplo,
             int M, int N, int K, int L,
             int vi2, int vi3,
             const float *A1, int LDA1,
                   float *A2, int LDA2,
                   ...
                   float *W, int LDW)
{
    ...
    */
    ...
    if (side == MorseLeft) {
        ...
        if (((trans == MorseTrans) && (uplo == CblasUpper)) ||
...
/***************************************************************************/
static inline int
CORE_spamm_a2(MORSE_enum side, MORSE_enum trans, MORSE_enum uplo,
              int M, int N, int K, int L,
              int vi2, int vi3,
                    float *A2, int LDA2,
              const float *V, int LDV,
