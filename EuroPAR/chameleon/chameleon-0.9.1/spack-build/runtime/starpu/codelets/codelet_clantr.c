...
{
    struct starpu_codelet *codelet = &cl_clantr;
...
static void cl_clantr_cpu_func(void *descr[], void *cl_arg)
{
    float *normA;
    ...
    CORE_clantr( norm, uplo, diag, M, N, A, LDA, work, normA);
}

/*
 * Codelet definition
 */
CODELETS_CPU(clantr, 3, cl_clantr_cpu_func)
