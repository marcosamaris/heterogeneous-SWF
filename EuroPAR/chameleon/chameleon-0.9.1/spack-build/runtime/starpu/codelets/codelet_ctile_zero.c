 ...
 *
 **/
static void cl_ctile_zero_cpu_func(void *descr[], void *cl_arg)
{
    int X1;
    int X2;
    int Y1;
 ...
 * Codelet definition
 */
CODELETS_CPU(ctile_zero, 1, cl_ctile_zero_cpu_func)
