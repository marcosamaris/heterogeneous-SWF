 ...
 *
 *  MORSE_TASK_splssq returns: scl * sqrt(ssq)
 *
...
{
    struct starpu_codelet *codelet = &cl_splssq;
    void (*callback)(void*) = options->profiling ? cl_splssq_callback : NULL;
...
static void cl_splssq_cpu_func(void *descr[], void *cl_arg)
{
    float *SCALESUMSQ;
    float *SCLSSQ;
 ...
 * Codelet definition
 */
CODELETS_CPU(splssq, 2, cl_splssq_cpu_func)

void MORSE_TASK_splssq2( MORSE_option_t *options,
                         MORSE_desc_t *RESULT, int RESULTm, int RESULTn )
{
    struct starpu_codelet *codelet = &cl_splssq2;
    void (*callback)(void*) = options->profiling ? cl_splssq2_callback : NULL;
...
static void cl_splssq2_cpu_func(void *descr[], void *cl_arg)
{
    float *RESULT;
 ...
 * Codelet definition
 */
CODELETS_CPU(splssq2, 1, cl_splssq2_cpu_func)
