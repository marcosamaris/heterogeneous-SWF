                        ...
                        int bigM, int m0, int n0, unsigned long long int seed )
{
    ...
    struct starpu_codelet *codelet = &cl_dplrnt;
    void (*callback)(void*) = options->profiling ? cl_dplrnt_callback : NULL;
...
static void cl_dplrnt_cpu_func(void *descr[], void *cl_arg)
{
    int m;
    int n;
    double *A;
 ...
 * Codelet definition
 */
CODELETS_CPU(dplrnt, 1, cl_dplrnt_cpu_func)
