...
{
    (void)nb;
    struct starpu_codelet *codelet = &cl_sttqrt;
    void (*callback)(void*) = options->profiling ? cl_sttqrt_callback : NULL;
...
static void cl_sttqrt_cpu_func(void *descr[], void *cl_arg)
{
    int m;
    int n;
    int ib;
 ...
 * Codelet definition
 */
CODELETS_CPU(sttqrt, 4, cl_sttqrt_cpu_func)
