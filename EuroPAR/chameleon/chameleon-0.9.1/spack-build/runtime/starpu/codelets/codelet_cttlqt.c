...
{
    (void)nb;
    struct starpu_codelet *codelet = &cl_cttlqt;
    void (*callback)(void*) = options->profiling ? cl_cttlqt_callback : NULL;
...
static void cl_cttlqt_cpu_func(void *descr[], void *cl_arg)
{
    int m;
    int n;
    int ib;
 ...
 * Codelet definition
 */
CODELETS_CPU(cttlqt, 4, cl_cttlqt_cpu_func)
