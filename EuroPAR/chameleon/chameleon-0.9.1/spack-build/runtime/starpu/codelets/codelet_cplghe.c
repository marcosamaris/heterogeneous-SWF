                        ...
                        int bigM, int m0, int n0, unsigned long long int seed )
{
    ...
    struct starpu_codelet *codelet = &cl_cplghe;
    void (*callback)(void*) = options->profiling ? cl_cplghe_callback : NULL;
...
static void cl_cplghe_cpu_func(void *descr[], void *cl_arg)
{
    float bump;
    int m;
    int n;
 ...
 * Codelet definition
 */
CODELETS_CPU(cplghe, 1, cl_cplghe_cpu_func);
