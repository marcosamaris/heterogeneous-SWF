...
{
    (void)nb;
    struct starpu_codelet *codelet = &cl_cgetrf;
    void (*callback)(void*) = options->profiling ? cl_cgetrf_callback : NULL;
...
static void cl_cgetrf_cpu_func(void *descr[], void *cl_arg)
{
    int m;
    int n;
    MORSE_Complex32_t *A;
 ...
 * Codelet definition
 */
CODELETS_CPU(cgetrf, 1, cl_cgetrf_cpu_func)
