...
{
    struct starpu_codelet *codelet = &cl_ctrasm;
...
static void cl_ctrasm_cpu_func(void *descr[], void *cl_arg)
{
    MORSE_enum storev;
    MORSE_enum uplo;
    MORSE_enum diag;
 ...
 * Codelet definition
 */
CODELETS_CPU(ctrasm, 2, cl_ctrasm_cpu_func)
