...
static void cl_dpotrf_cpu_func(void *descr[], void *cl_arg)
{
    MORSE_enum uplo;
    int n;
    double *A;
...
static void cl_dpotrf_cuda_func(void *descr[], void *cl_arg)
{
    ...
    /*  *  hwork => nb*nb */
    /*  *\/ */
    /* hA = (double *)STARPU_MATRIX_GET_PTR(descr[1]); */
...
CODELETS(dpotrf, 1, cl_dpotrf_cpu_func, cl_dpotrf_cuda_func, 0)
#else
CODELETS_CPU(dpotrf, 1, cl_dpotrf_cpu_func)
#endif
