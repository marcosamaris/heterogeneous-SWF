...
{
    (void)nb;
    struct starpu_codelet *codelet = &cl_clacpy;
    void (*callback)(void*) = options->profiling ? cl_clacpy_callback : NULL;
...
static void cl_clacpy_cpu_func(void *descr[], void *cl_arg)
{
    MORSE_enum uplo;
    int M;
    int N;
 ...
 * Codelet definition
 */
CODELETS_CPU(clacpy, 2, cl_clacpy_cpu_func)
