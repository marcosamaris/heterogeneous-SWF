 ...
 *
 *  MORSE_TASK_dplssq returns: scl * sqrt(ssq)
 *
...
{
    struct starpu_codelet *codelet = &cl_dplssq;
    void (*callback)(void*) = options->profiling ? cl_dplssq_callback : NULL;
...
static void cl_dplssq_cpu_func(void *descr[], void *cl_arg)
{
    double *SCALESUMSQ;
    double *SCLSSQ;
 ...
 * Codelet definition
 */
CODELETS_CPU(dplssq, 2, cl_dplssq_cpu_func)

void MORSE_TASK_dplssq2( MORSE_option_t *options,
                         MORSE_desc_t *RESULT, int RESULTm, int RESULTn )
{
    struct starpu_codelet *codelet = &cl_dplssq2;
    void (*callback)(void*) = options->profiling ? cl_dplssq2_callback : NULL;
...
static void cl_dplssq2_cpu_func(void *descr[], void *cl_arg)
{
    double *RESULT;
 ...
 * Codelet definition
 */
CODELETS_CPU(dplssq2, 1, cl_dplssq2_cpu_func)
