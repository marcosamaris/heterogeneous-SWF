 ...
 *
 *  CORE_dttmqr overwrites the general real M1-by-N1 tile A1 and
...
{
    (void)nb;
    struct starpu_codelet *codelet = &cl_dttmqr;
    void (*callback)(void*) = options->profiling ? cl_dttmqr_callback : NULL;
...
static void cl_dttmqr_cpu_func(void *descr[], void *cl_arg)
{
    MORSE_enum side;
    MORSE_enum trans;
    int m1;
 ...
 * Codelet definition
 */
CODELETS_CPU(dttmqr, 5, cl_dttmqr_cpu_func)
