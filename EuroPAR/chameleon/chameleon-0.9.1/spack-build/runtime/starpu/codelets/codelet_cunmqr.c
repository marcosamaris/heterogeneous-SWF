...
{
    struct starpu_codelet *codelet = &cl_cunmqr;
    void (*callback)(void*) = options->profiling ? cl_cunmqr_callback : NULL;
...
static void cl_cunmqr_cpu_func(void *descr[], void *cl_arg)
{
    MORSE_enum side;
    MORSE_enum trans;
    int m;
...
magma_int_t
magma_cunmqrt_gpu( magma_side_t side, magma_trans_t trans,
...
static void cl_cunmqr_cuda_func(void *descr[], void *cl_arg)
{
    ...
    magma_cunmqrt_gpu( side, trans, m, n, k, ib,
                       A, lda, T, ldt, C, ldc, WORK, ldwork );
...
CODELETS(cunmqr, 4, cl_cunmqr_cpu_func, cl_cunmqr_cuda_func, 0)
#else
CODELETS_CPU(cunmqr, 4, cl_cunmqr_cpu_func)
#endif
