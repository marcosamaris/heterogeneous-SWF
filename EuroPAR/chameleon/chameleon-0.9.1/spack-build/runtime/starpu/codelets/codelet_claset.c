                       ...
                       MORSE_desc_t *A, int Am, int An, int LDA)
{
    ...
    struct starpu_codelet *codelet = &cl_claset;
    void (*callback)(void*) = options->profiling ? cl_claset_callback : NULL;
...
static void cl_claset_cpu_func(void *descr[], void *cl_arg)
{
    MORSE_enum uplo;
    int M;
    int N;
 ...
 * Codelet definition
 */
CODELETS_CPU(claset, 1, cl_claset_cpu_func)
