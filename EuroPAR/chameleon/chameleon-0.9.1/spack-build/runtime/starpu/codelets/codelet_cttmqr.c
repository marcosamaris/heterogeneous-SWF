...
{
    (void)nb;
    struct starpu_codelet *codelet = &cl_cttmqr;
    void (*callback)(void*) = options->profiling ? cl_cttmqr_callback : NULL;
...
static void cl_cttmqr_cpu_func(void *descr[], void *cl_arg)
{
    MORSE_enum side;
    MORSE_enum trans;
    int m1;
 ...
 * Codelet definition
 */
CODELETS_CPU(cttmqr, 5, cl_cttmqr_cpu_func)
