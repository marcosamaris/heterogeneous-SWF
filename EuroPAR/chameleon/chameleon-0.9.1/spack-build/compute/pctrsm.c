 ...
 **/
void morse_pctrsm(MORSE_enum side, MORSE_enum uplo, MORSE_enum trans, MORSE_enum diag,
                         ...
                         MORSE_sequence_t *sequence, MORSE_request_t *request)
{
    ...
    MORSE_Complex32_t minvalpha  = (MORSE_Complex32_t)-1.0 / alpha;
    MORSE_Complex32_t lalpha;
