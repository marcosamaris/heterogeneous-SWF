...
//int MORSE_dgesvd(MORSE_enum jobu, MORSE_enum jobvt, int M, int N, double *A, int LDA, double *S, double *U, int LDU, double *VT, int LDVT, MORSE_desc_t *descT);
...
//int MORSE_dsyevd(MORSE_enum jobz, MORSE_enum uplo, int N, double *A, int LDA, double *W, MORSE_desc_t *descT, double *Q, int LDQ);
...
#ifdef COMPLEX
int MORSE_dplgsy( double bump, int N, double *A, int LDA, unsigned long long int seed );
#endif
int MORSE_dplgsy( double bump, int N, double *A, int LDA, unsigned long long int seed );
...
//int MORSE_dgesvd_Tile(MORSE_enum jobu, MORSE_enum jobvt, MORSE_desc_t *A, double *S, MORSE_desc_t *U, MORSE_desc_t *VT, MORSE_desc_t *T);
...
//int MORSE_dsyevd_Tile(MORSE_enum jobz, MORSE_enum uplo, MORSE_desc_t *A, double *W, MORSE_desc_t *T, double *Q, int LDQ);
...
#ifdef COMPLEX
int MORSE_dplgsy_Tile(double bump, MORSE_desc_t *A, unsigned long long int seed );
#endif
int MORSE_dplgsy_Tile(double bump, MORSE_desc_t *A, unsigned long long int seed );
...
//int MORSE_dgesvd_Tile_Async(MORSE_enum jobu, MORSE_enum jobvt, MORSE_desc_t *A, double *S, MORSE_desc_t *U, MORSE_desc_t *VT, MORSE_desc_t *T, MORSE_sequence_t *sequence, MORSE_request_t *request);
...
//int MORSE_dsyevd_Tile_Async(MORSE_enum jobz, MORSE_enum uplo, MORSE_desc_t *A, double *W, MORSE_desc_t *T, double *Q, int LDQ, MORSE_sequence_t *sequence, MORSE_request_t *request);
...
#ifdef COMPLEX
int MORSE_dplgsy_Tile_Async(double bump, MORSE_desc_t *A, unsigned long long int seed, MORSE_sequence_t *sequence, MORSE_request_t *request );
#endif
int MORSE_dplgsy_Tile_Async(double bump, MORSE_desc_t *A, unsigned long long int seed, MORSE_sequence_t *sequence, MORSE_request_t *request );
...
int MORSE_Alloc_Workspace_dgelqf(int M, int N, MORSE_desc_t **T);
int MORSE_Alloc_Workspace_dgels( int M, int N, MORSE_desc_t **T);
int MORSE_Alloc_Workspace_dgeqrf(int M, int N, MORSE_desc_t **T);
