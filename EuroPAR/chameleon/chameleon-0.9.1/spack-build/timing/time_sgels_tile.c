...
RunTest(int *iparam, float *dparam, morse_time_t *t_) 
{
    ...
    PASTE_CODE_ALLOCATE_MATRIX_TILE( descX,      1, float, MorseRealFloat, LDB, M, NRHS );
    ...
    /* Do the computations */
    START_TIMING();
    MORSE_sgels_Tile( MorseNoTrans, descA, descT, descX );
    STOP_TIMING();
