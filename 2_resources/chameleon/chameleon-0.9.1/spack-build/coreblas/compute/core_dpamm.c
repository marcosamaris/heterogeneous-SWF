...
static inline int CORE_dpamm_a2(MORSE_enum side, MORSE_enum trans, MORSE_enum uplo,
                                int M, int N, int K, int L,
                                int vi2, int vi3,
                                double *A2, int LDA2,
                                const double *V, int LDV,
                                double *W, int LDW);
static inline int CORE_dpamm_w(MORSE_enum side, MORSE_enum trans, MORSE_enum uplo,
                               int M, int N, int K, int L,
                               int vi2, int vi3,
 ...
 ******************************************************************************/
int
CORE_dpamm(int op, MORSE_enum side, MORSE_enum storev,
           int M, int N, int K, int L,
           const double *A1, int LDA1,
                 double *A2, int LDA2,
           const double *V, int LDV,
...
/***************************************************************************/
static inline int
CORE_dpamm_w(MORSE_enum side, MORSE_enum trans, MORSE_enum uplo,
             int M, int N, int K, int L,
             int vi2, int vi3,
             const double *A1, int LDA1,
                   double *A2, int LDA2,
...
/***************************************************************************/
static inline int
CORE_dpamm_a2(MORSE_enum side, MORSE_enum trans, MORSE_enum uplo,
              int M, int N, int K, int L,
              int vi2, int vi3,
                    double *A2, int LDA2,
              const double *V, int LDV,
