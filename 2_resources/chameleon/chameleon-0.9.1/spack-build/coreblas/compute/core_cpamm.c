...
static inline int CORE_cpamm_a2(MORSE_enum side, MORSE_enum trans, MORSE_enum uplo,
                                int M, int N, int K, int L,
                                int vi2, int vi3,
                                MORSE_Complex32_t *A2, int LDA2,
                                const MORSE_Complex32_t *V, int LDV,
                                MORSE_Complex32_t *W, int LDW);
static inline int CORE_cpamm_w(MORSE_enum side, MORSE_enum trans, MORSE_enum uplo,
                               int M, int N, int K, int L,
                               int vi2, int vi3,
 ...
 ******************************************************************************/
int
CORE_cpamm(int op, MORSE_enum side, MORSE_enum storev,
           int M, int N, int K, int L,
           const MORSE_Complex32_t *A1, int LDA1,
                 MORSE_Complex32_t *A2, int LDA2,
           const MORSE_Complex32_t *V, int LDV,
...
/***************************************************************************/
static inline int
CORE_cpamm_w(MORSE_enum side, MORSE_enum trans, MORSE_enum uplo,
             int M, int N, int K, int L,
             int vi2, int vi3,
             const MORSE_Complex32_t *A1, int LDA1,
                   MORSE_Complex32_t *A2, int LDA2,
                   ...
                   MORSE_Complex32_t *W, int LDW)
{
    ...
    */
    ...
    static MORSE_Complex32_t czero =  0.0;
...
/***************************************************************************/
static inline int
CORE_cpamm_a2(MORSE_enum side, MORSE_enum trans, MORSE_enum uplo,
              int M, int N, int K, int L,
              int vi2, int vi3,
                    MORSE_Complex32_t *A2, int LDA2,
              const MORSE_Complex32_t *V, int LDV,
