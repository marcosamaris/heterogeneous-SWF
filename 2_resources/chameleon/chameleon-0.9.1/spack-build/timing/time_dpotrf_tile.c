...
#define _NAME  "MORSE_dpotrf_Tile"
...
RunTest(int *iparam, double *dparam, morse_time_t *t_)
{
    ...
    PASTE_CODE_ALLOCATE_MATRIX_TILE( descX,  check, double, MorseRealDouble, LDB, N, NRHS );
    ...
    //RUNTIME_dlocality_allrestrict( STARPU_CUDA );
...
//        MORSE_dpotrs_Tile( uplo, descA, descB );
