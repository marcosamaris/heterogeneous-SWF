...
{
    struct starpu_codelet *codelet = &cl_strasm;
...
static void cl_strasm_cpu_func(void *descr[], void *cl_arg)
{
    MORSE_enum storev;
    MORSE_enum uplo;
    MORSE_enum diag;
 ...
 * Codelet definition
 */
CODELETS_CPU(strasm, 2, cl_strasm_cpu_func)
