                       ...
                       MORSE_desc_t *A, int Am, int An, int LDA)
{
    ...
    struct starpu_codelet *codelet = &cl_dlaset;
    void (*callback)(void*) = options->profiling ? cl_dlaset_callback : NULL;
...
static void cl_dlaset_cpu_func(void *descr[], void *cl_arg)
{
    MORSE_enum uplo;
    int M;
    int N;
 ...
 * Codelet definition
 */
CODELETS_CPU(dlaset, 1, cl_dlaset_cpu_func)
