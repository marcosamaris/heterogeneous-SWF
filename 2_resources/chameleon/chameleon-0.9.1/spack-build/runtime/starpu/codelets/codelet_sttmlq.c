 ...
 *
 *  CORE_sttmlq overwrites the general real M1-by-N1 tile A1 and
...
{
    (void)nb;
    struct starpu_codelet *codelet = &cl_sttmlq;
    void (*callback)(void*) = options->profiling ? cl_sttmlq_callback : NULL;
...
static void cl_sttmlq_cpu_func(void *descr[], void *cl_arg)
{
    MORSE_enum side;
    MORSE_enum trans;
    int m1;
 ...
 * Codelet definition
 */
CODELETS_CPU(sttmlq, 5, cl_sttmlq_cpu_func)
