...
{
    struct starpu_codelet *codelet = &cl_slantr;
...
static void cl_slantr_cpu_func(void *descr[], void *cl_arg)
{
    float *normA;
    ...
    CORE_slantr( norm, uplo, diag, M, N, A, LDA, work, normA);
}

/*
 * Codelet definition
 */
CODELETS_CPU(slantr, 3, cl_slantr_cpu_func)
