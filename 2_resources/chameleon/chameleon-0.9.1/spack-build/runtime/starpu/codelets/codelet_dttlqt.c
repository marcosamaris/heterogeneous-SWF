...
{
    (void)nb;
    struct starpu_codelet *codelet = &cl_dttlqt;
    void (*callback)(void*) = options->profiling ? cl_dttlqt_callback : NULL;
...
static void cl_dttlqt_cpu_func(void *descr[], void *cl_arg)
{
    int m;
    int n;
    int ib;
 ...
 * Codelet definition
 */
CODELETS_CPU(dttlqt, 4, cl_dttlqt_cpu_func)
