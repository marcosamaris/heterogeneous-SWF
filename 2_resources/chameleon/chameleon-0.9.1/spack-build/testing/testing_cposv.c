...
int testing_cposv(int argc, char **argv)
{
    ...
    MORSE_Complex32_t *B1   = (MORSE_Complex32_t *)malloc(LDB*NRHS*sizeof(MORSE_Complex32_t));
    MORSE_Complex32_t *B2   = (MORSE_Complex32_t *)malloc(LDB*NRHS*sizeof(MORSE_Complex32_t));
    ...
    */
    ...
    MORSE_cplrnt( N, NRHS, B1, LDB, 371 );
    MORSE_clacpy( MorseUpperLower, N, NRHS, B1, LDB, B2, LDB );

    printf("\n");
    printf("------ TESTS FOR CHAMELEON CPOSV ROUTINE -------  \n");
    ...
    /* MORSE CPOSV */
    MORSE_cposv(uplo, N, NRHS, A2, LDA, B2, LDB);
    ...
    */
    ...
    MORSE_cpotrs(uplo, N, NRHS, A2, LDA, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR CHAMELEON CPOTRF + CPOTRS ROUTINE -------  \n");
    printf("            Size of the Matrix %d by %d\n", N, N);
    printf("\n");
    printf(" The matrix A is randomly generated for each test.\n");
    printf("============\n");
    ...
    */
    ...
    /* MORSE routines */
    MORSE_cpotrf(uplo, N, A2, LDA);
    MORSE_ctrsm(MorseLeft, uplo, trans1, MorseNonUnit, 
                 N, NRHS, 1.0, A2, LDA, B2, LDB);
    MORSE_ctrsm(MorseLeft, uplo, trans2, MorseNonUnit, 
                 N, NRHS, 1.0, A2, LDA, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR CHAMELEON CPOTRF + CTRSM + CTRSM  ROUTINE -------  \n");
    printf("            Size of the Matrix %d by %d\n", N, N);
    printf("\n");
    printf(" The matrix A is randomly generated for each test.\n");
    printf("============\n");
