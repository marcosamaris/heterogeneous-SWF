...
int testing_sgesv_incpiv(int argc, char **argv)
{
    ...
    */
    ...
    /* MORSE SGESV */
    MORSE_Alloc_Workspace_sgesv_incpiv(N, &L, &IPIV);
    MORSE_sgesv_incpiv(N, NRHS, A2, LDA, L, IPIV, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR CHAMELEON INCPIV SGESV ROUTINE -------  \n");
    ...
    */
    ...
    /* Morse routines */
    MORSE_sgetrf_incpiv(N, N, A2, LDA, L, IPIV);
    MORSE_sgetrs_incpiv(MorseNoTrans, N, NRHS, A2, LDA, L, IPIV, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR CHAMELEON SGETRF + SGETRS ROUTINE -------  \n");
    printf("            Size of the Matrix %d by %d\n", N, N);
    printf("\n");
    printf(" The matrix A is randomly generated for each test.\n");
    printf("============\n");
    ...
    */
    ...
    /* MORSE routines */
    MORSE_sgetrf_incpiv(N, N, A2, LDA, L, IPIV);
    MORSE_strsmpl(N, NRHS, A2, LDA, L, IPIV, B2, LDB);
    MORSE_strsm(MorseLeft, MorseUpper, MorseNoTrans, MorseNonUnit,
                 N, NRHS, 1.0, A2, LDA, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR CHAMELEON INCPIV SGETRF + STRSMPL + STRSM  ROUTINE -------  \n");
    printf("            Size of the Matrix %d by %d\n", N, N);
    printf("\n");
    printf(" The matrix A is randomly generated for each test.\n");
    printf("============\n");
