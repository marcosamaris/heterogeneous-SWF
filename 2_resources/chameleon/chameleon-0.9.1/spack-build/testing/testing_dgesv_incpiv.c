...
int testing_dgesv_incpiv(int argc, char **argv)
{
    ...
    */
    ...
    /* MORSE DGESV */
    MORSE_Alloc_Workspace_dgesv_incpiv(N, &L, &IPIV);
    MORSE_dgesv_incpiv(N, NRHS, A2, LDA, L, IPIV, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR CHAMELEON INCPIV DGESV ROUTINE -------  \n");
    ...
    */
    ...
    /* Morse routines */
    MORSE_dgetrf_incpiv(N, N, A2, LDA, L, IPIV);
    MORSE_dgetrs_incpiv(MorseNoTrans, N, NRHS, A2, LDA, L, IPIV, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR CHAMELEON DGETRF + DGETRS ROUTINE -------  \n");
    printf("            Size of the Matrix %d by %d\n", N, N);
    printf("\n");
    printf(" The matrix A is randomly generated for each test.\n");
    printf("============\n");
    ...
    */
    ...
    /* MORSE routines */
    MORSE_dgetrf_incpiv(N, N, A2, LDA, L, IPIV);
    MORSE_dtrsmpl(N, NRHS, A2, LDA, L, IPIV, B2, LDB);
    MORSE_dtrsm(MorseLeft, MorseUpper, MorseNoTrans, MorseNonUnit,
                 N, NRHS, 1.0, A2, LDA, B2, LDB);

    printf("\n");
    printf("------ TESTS FOR CHAMELEON INCPIV DGETRF + DTRSMPL + DTRSM  ROUTINE -------  \n");
    printf("            Size of the Matrix %d by %d\n", N, N);
    printf("\n");
    printf(" The matrix A is randomly generated for each test.\n");
    printf("============\n");
