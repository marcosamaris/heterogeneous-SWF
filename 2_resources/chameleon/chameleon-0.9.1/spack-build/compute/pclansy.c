 ...
 *
 **/
void morse_pclansy(MORSE_enum norm, MORSE_enum uplo, MORSE_desc_t *A, float *result,
                   MORSE_sequence_t *sequence, MORSE_request_t *request)
{
    ...
    *result = 0.0;
    ...
    case MorseOneNorm:
    case MorseInfNorm:
        /* Init workspace handle for the call to clange */
    ...
    case MorseMaxNorm:
    default:
        /* Init workspace handle for the call to clange but unused */
