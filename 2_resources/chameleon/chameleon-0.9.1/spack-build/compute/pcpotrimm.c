 ...
 **/
void morse_pcpotrimm(MORSE_enum uplo, MORSE_desc_t *A, MORSE_desc_t *B, MORSE_desc_t *C,
                          MORSE_sequence_t *sequence, MORSE_request_t *request)
{
    ...
    MORSE_Complex32_t alpha  = (MORSE_Complex32_t) 1.0;
    MORSE_Complex32_t beta  = (MORSE_Complex32_t) 0.0;
    MORSE_Complex32_t zbeta;
    MORSE_Complex32_t zone  = (MORSE_Complex32_t) 1.0;
    ...
    {
      int nb = magma_get_cpotrf_nb(A->nb);
