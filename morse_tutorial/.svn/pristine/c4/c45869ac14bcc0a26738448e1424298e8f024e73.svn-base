...
def main(argv):
    ...
    for th in alltimes:
        if alltimes[th]:
            ...
            if(alltimes[th].has_key('OGEMQRT'   )): th_ex_time += alltimes[th]['OGEMQRT'   ]
            if(alltimes[th].has_key('IGEMQRT'   )): th_ex_time += alltimes[th]['IGEMQRT'   ]
            if(alltimes[th].has_key('PARTITION' )): th_ex_time += alltimes[th]['PARTITION' ]
